...
void __thiscall rigid_body_constraint_contact::~rigid_body_constraint_contact(rigid_body_constraint_contact *this)
{
  phys_inplace_avl_tree<rigid_body_pair_key,rigid_body_constraint_contact,rigid_body_constraint_contact::avl_tree_accessor>::remove(
    ...
    (phys_inplace_avl_tree<rigid_body_pair_key,rigid_body_constraint_contact,rigid_body_constraint_contact::avl_tree_accessor>::stack_item *)&this->m_avl_key);
}
        ...
        float delta_t)
{
  ...
  result = (pulse_sum_contact *)phys_transient_allocator::allocate(
                                  &this->m_solver_memory_allocator,
                                  208 * cpi->m_point_pair_count + 96,
                                  16,
                                  1,
